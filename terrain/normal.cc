...
TessEffectPtr CreateTessEffect() {
  ...
  Shaders shaders;
  LoadStageShader(kVertexStage, "demo/terrain/normal/vs.hlsl", &shaders);
  LoadStageShader(kHullStage, "demo/terrain/normal/hs.hlsl", &shaders);
  LoadStageShader(kDomainStage, "demo/terrain/normal/ds.hlsl", &shaders);
  LoadStageShader(kPixelStage, "demo/terrain/normal/ps.hlsl", &shaders);
